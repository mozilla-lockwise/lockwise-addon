...
item-fileds-origin-error-message = Must include “https://“ or “http://“
item-fileds-origin-info-message = Make sure this matches the exact domain for the website you are referencing (“https://” and “www” included).
