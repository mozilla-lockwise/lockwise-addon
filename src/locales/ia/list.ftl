...
all-items-get-started-footer = Non vide tu credentiales salvate? <go>Discoperi perque</go>
...
intro-page-footer-copy = { -fxlockwise-brand-name } forni accesso al credentiales salvate in { -firefox-brand-name } sur tu dispositivo. Si tu credentiales es immagazinate sur un altere dispositivo, tu pote synchronisar tu informationes a iste dispositivo per aperir session o per crear un { -fxaccount-brand-name }. <go>Saper plus</go>
...
simply-sign-in-other-device = Aperi session a tu { -fxaccount-brand-name } sur tu altere dispositivo pro synchronisar tu credentiales con ille computator.
