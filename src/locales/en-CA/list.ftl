...
error-notification-duplicate = A login for { $title } with that username already exists.
error-notification-duplicate-link = <a>Go to existing login?</a>
all-items-get-started = When you save a password in { -firefox-brand-name }, it will show up here.
all-items-get-started-title = No logins found.
all-items-get-started-footer = Not seeing your saved logins? <go>Find out why</go>
all-items-no-results = If this login is saved on another device, make sure you have signed in and synced on that device in order to see it here.
...
intro-page-main-article-1-title = Easy management of your accounts
...
intro-page-main-article-2-title = Quick access to your logins
...
intro-page-main-article-3-title = Create new logins manually
...
intro-page-footer-heading = Not seeing your saved logins? Let us help.
